...
!!! info
    ...
    - A correct DNS setup is crucial to every good mailserver setup, so please make sure you got at least the [basics](https://mailcow.github.io/mailcow-dockerized-docs/prerequisite-dns/) covered before you begin!
