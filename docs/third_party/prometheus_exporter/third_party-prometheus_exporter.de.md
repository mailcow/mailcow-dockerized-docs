...
Wenn du den Exporter über den Mailcow-internen Nginx erreichbar machen möchtest, erstelle die folgende Datei: `data/conf/nginx/site.metrics.custom` und entferne aus der `docker-compose.override.yml` den Bereich mit `ports: - "9099:9099"`
