...
services:
  ...
  roundcube:
    image: roundcube/roundcubemail:1.6.13-apache # See newest version https://hub.docker.com/r/roundcube/roundcubemail/tags?name=apache
    environment:
...
=== "Standalone"
    ...
    ```yaml
    image: roundcube/roundcubemail:1.6.13-apache # 1.6.13 -> 1.6.X (in the futur: 1.7.X)
    ```
